...
import {
  ...
  capitalGainsCalculatorDefinition,
  capitalGainsKnowledgeContent,
} from "@/features/calculators/capital-gains"
import { createCalculatorMetadata } from "@/lib/seo"
import { siteConfig } from "@/lib/site-config"

const calculator = capitalGainsCalculatorDefinition
  ...
  "@graph": [
    {
      ...
      featureList: "Section 111A/112A short-term and long-term capital gains tax estimate, FIFO multi-lot matching, pre-2018 grandfathering cost-basis rule, pooled LTCG exemption, per-lot breakdown, validated sharing, copy, and print support",
    },
    {
      "@type": "BreadcrumbList",
      itemListElement: [
      ...
      <SiteContainer className="py-8 sm:py-10">
        ...
        <div className="mt-16 space-y-6 sm:mt-20 sm:space-y-8">
          {calculator.formula || calculator.workedExample ? (
            <CollapsibleSection title="Formula and worked example" description="How FIFO matching, grandfathering, and the STCG/LTCG tax are calculated, with a sample case worked through step by step.">
          ...
          <CollapsibleSection title={capitalGainsKnowledgeContent.title} description={capitalGainsKnowledgeContent.description}>
            <CalculatorContentLayout content={capitalGainsKnowledgeContent} />
          </CollapsibleSection>
          <CollapsibleSection title="Frequently asked questions" description="Common questions about capital gains tax on equity shares and mutual funds, and how this calculator works.">
