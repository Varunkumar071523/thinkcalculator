...
export const metadata: Metadata = {
  title: calculator.metadata.title, description: calculator.metadata.description,
  ...
  openGraph: { type: "website", url: calculator.canonicalPath, title: calculator.metadata.title, description: calculator.metadata.description, siteName: siteConfig.name },
