...
import { NPSCalculator, npsCalculatorDefinition, npsKnowledgeContent } from "@/features/calculators/nps"
import { getPublishedGlossaryTerms } from "@/features/content"
import { createCalculatorMetadata, createCanonicalUrl } from "@/lib/seo"

const calculator = npsCalculatorDefinition
      ...
      <SiteContainer className="py-8 sm:py-10">
        ...
        <div className="mt-16 space-y-6 sm:mt-20 sm:space-y-8">
          {calculator.formula || calculator.workedExample ? (
            <CollapsibleSection title="Formula and worked example" description="How the NPS corpus is projected, with a sample scenario worked through step by step.">
          ...
          <CollapsibleSection title={npsKnowledgeContent.title} description={npsKnowledgeContent.description}>
            <CalculatorContentLayout content={npsKnowledgeContent} />
          </CollapsibleSection>
          <CollapsibleSection title="Frequently asked questions" description="Common questions about NPS and how this calculator works.">
