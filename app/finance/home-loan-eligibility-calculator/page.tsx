...
import { HomeLoanEligibilityCalculator, homeLoanEligibilityCalculatorDefinition, homeLoanEligibilityKnowledgeContent } from "@/features/calculators/home-loan-eligibility"
import { getPublishedGlossaryTerms } from "@/features/content"
import { siteConfig } from "@/lib/site-config"
import { createCalculatorMetadata } from "@/lib/seo"

const calculator = homeLoanEligibilityCalculatorDefinition
      ...
      <SiteContainer className="py-8 sm:py-10">
        ...
        <div className="mt-16 space-y-6 sm:mt-20 sm:space-y-8">
          {calculator.formula || calculator.workedExample ? (
            <CollapsibleSection title="Formula and worked example" description="How the FOIR method and reverse-EMI calculation work, with a sample income and loan scenario worked through step by step.">
          ...
          <CollapsibleSection title={homeLoanEligibilityKnowledgeContent.title} description={homeLoanEligibilityKnowledgeContent.description}>
            <CalculatorContentLayout content={homeLoanEligibilityKnowledgeContent} />
          </CollapsibleSection>
          <CollapsibleSection title="Frequently asked questions" description="Common questions about FOIR, home loan eligibility, and how this calculator works.">
