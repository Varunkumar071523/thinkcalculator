...
import { InflationCalculator, inflationCalculatorDefinition as calculator, inflationKnowledgeContent } from "@/features/calculators/inflation"
      ...
      <SiteContainer className="py-8 sm:py-10">
        ...
        <div className="mt-16 space-y-6 sm:mt-20 sm:space-y-8">
          {calculator.formula || calculator.workedExample ? (
            <CollapsibleSection title="Formula and worked example" description="How inflation impact is calculated, with a sample amount worked through step by step.">
          ...
          <CollapsibleSection title={inflationKnowledgeContent.title} description={inflationKnowledgeContent.description}>
            <CalculatorContentLayout content={inflationKnowledgeContent} />
          </CollapsibleSection>
          <CollapsibleSection title="Frequently asked questions" description="Common questions about inflation and how this calculator works.">
