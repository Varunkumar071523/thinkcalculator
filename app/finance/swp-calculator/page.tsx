      ...
      <SiteContainer className="py-8 sm:py-10">
        ...
        <div className="mt-16 space-y-6 sm:mt-20 sm:space-y-8">
          {calculator.formula || calculator.workedExample ? (
            <CollapsibleSection title="Formula and worked example" description="How the SWP balance is projected, with a sample withdrawal plan worked through step by step.">
          ...
          <CollapsibleSection title={swpKnowledgeContent.title} description={swpKnowledgeContent.description}>
            <CalculatorContentLayout content={swpKnowledgeContent} />
          </CollapsibleSection>
          <CollapsibleSection title="Frequently asked questions" description="Common questions about SWPs and how this calculator works.">
