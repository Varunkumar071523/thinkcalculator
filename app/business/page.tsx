...
export const businessCalculators: CalculatorSummary[] = calculatorRegistry
  ...
  .map((calculator) => ({ title: calculator.title, href: calculator.canonicalPath, description: calculator.description, category: calculator.category, icon: iconBySlug[calculator.slug as keyof typeof iconBySlug] ?? BarChart3 }))
