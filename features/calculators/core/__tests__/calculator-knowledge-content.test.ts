...
import { capitalGainsCalculatorDefinition, capitalGainsKnowledgeContent } from "@/features/calculators/capital-gains"

const productionRoutes = new Set(["/finance/emi-calculator", "/finance/sip-calculator", "/finance/step-up-sip-calculator", "/glossary/step-up-sip", "/finance/swp-calculator", "/glossary/swp", "/finance/inflation-calculator", "/glossary/inflation", "/finance/lumpsum-calculator", "/finance/fd-calculator", "/finance/rd-calculator", "/finance/cagr-calculator", "/finance/ppf-calculator", "/business/gst-calculator", "/finance/gratuity-calculator", "/glossary/gratuity", "/finance/retirement-corpus-calculator", "/glossary/retirement-corpus", "/finance/income-tax-calculator", "/finance/hra-calculator", "/finance/home-loan-eligibility-calculator", "/finance/epf-calculator", "/finance/nps-calculator", "/finance/leave-encashment-calculator", "/finance/capital-gains-calculator"])
const calculators = [
  ...
  { definition: capitalGainsCalculatorDefinition, content: capitalGainsKnowledgeContent },
]
