...
export const topicRegistry: readonly TopicDefinition[] = [
  ...
  },
  {
    ...
    calculatorIds: ["sip-calculator", "step-up-sip-calculator", "lumpsum-calculator", "cagr-calculator"],
    editorialIds: ["blog-sip-vs-lumpsum", "guide-estimate-sip"],
    glossaryIds: ["glossary-sip", "glossary-step-up-sip", "glossary-compounding", "glossary-cagr", "glossary-principal", "glossary-tenure"],
  },
  {
