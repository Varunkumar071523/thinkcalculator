...
describe("editorial content quality", () => {
  ...
  it("includes the required calculator mappings", () => { const mappings: Record<string, string[]> = { "understanding-loan-emi": ["/finance/emi-calculator"], "sip-vs-lumpsum": ["/finance/sip-calculator", "/finance/lumpsum-calculator"], "how-to-use-emi-calculator": ["/finance/emi-calculator"], "how-to-estimate-sip-growth": ["/finance/sip-calculator", "/finance/lumpsum-calculator"] }; published.forEach((item) => expect(item.relatedCalculators.map((link) => link.href)).toEqual(mappings[item.slug])) })
})
